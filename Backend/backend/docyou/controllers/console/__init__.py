...
console_urls = [
    ...
    path('console/api/account/organization_role',
         UpdateOrganzationRoleAPI.as_view()),
    path('console/api/account/project_role', UpdateProjectRoleAPI.as_view()),
    path('console/api/refresh-token', RefreshTokenAPI.as_view()),
    path('console/api/register', RegisterAccountAPI.as_view()),
    ...
    path('console/api/activate/check', ActivateCheckAPI.as_view()),
    path('console/api/activate', ActivateAPI.as_view()),
]
