...
console_urls = [
    ...
    path('console/api/account/login', LoginAPI.as_view()),
    path('console/api/account/logout', LogoutAPI.as_view()),
    path('console/api/account/forgot_password', ForgotPasswordAPI.as_view()),
