...
import { Box, Card, Flex, Heading, Text, Link as RLink, TextField, Button as RButton } from "@radix-ui/themes";
  ...
  return (
    <Card size="4">
      ...
      <Flex mt="6" justify="end" gap="3">
        <RButton tabIndex={tabIndex} variant="outline">
          Create an account
        </RButton>
        <RButton tabIndex={tabIndex}>Sign in</RButton>
      </Flex>
    </Card>
  );
  // return (
