const translation = {
  welcome: 'Welcome, Please sign in with active account credentials to use the full capablity of DocYou.',
  email: 'Email address',
  ...
  or: 'OR',
  installBtn: 'Set up',
  setAdminAccount: 'Set Up Admin Account',
  setAccount: 'Set Up Account',
